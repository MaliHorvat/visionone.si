      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="rounded-lg border border-[var(--vo-border)] bg-[var(--vo-surface-2)] px-4 py-2 text-sm">
            ...
            <span className="font-medium capitalize text-[var(--vo-fg)]">{client.package}</span>
          </div>
        </div>
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-[var(--vo-border)] bg-[var(--vo-surface)] p-5 shadow-[var(--vo-card-shadow)]">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {client.switches.map((s) => (
                <li key={s.id} className="flex justify-between gap-2 border-b border-[var(--vo-border)] pb-2 last:border-0">
          ...
          <div className="rounded-xl border border-[var(--vo-border)] bg-[var(--vo-surface)] p-5 shadow-[var(--vo-card-shadow)]">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {client.disks.map((d) => (
                <li key={d.id} className="flex flex-wrap justify-between gap-2 border-b border-[var(--vo-border)] pb-2 last:border-0">
