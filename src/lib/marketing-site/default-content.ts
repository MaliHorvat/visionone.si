...
const DEFAULT_PAGES: MarketingSiteContent["pages"] = {
  home: {
    hero: {
...
export const DEFAULT_MARKETING_SITE_CONTENT: MarketingSiteContent = {
  ...
  images: {
    MARKETING_IMG_HERO: img(
      "MARKETING_IMG_HERO",
      "Domov — hero ozadje",
      "/images/cctv.jpg",
      "Varnostni kameri na objektu",
      {
        objectPosition: "center right",
      },
    ),
    MARKETING_IMG_CCTV: img(
      "MARKETING_IMG_CCTV",
      "Domov + Storitve — split levo",
      "/images/warehouse.jpg",
      "Skladiščni objekt z videonadzorom",
    ),
    ...
    MARKETING_IMG_DOMOV_ZAKAJ_INTRO: img(
      ...
      "/images/noc.jpg",
      "Spremljanje sistemov v realnem času",
    ),
